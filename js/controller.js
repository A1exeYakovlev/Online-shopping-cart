import { userDataObj, pickpointsInfo, sellersData, cartItemObjArr, storeTerms } from "./model.js";

import { item1QuantVal, item2QuantVal, item3QuantVal, itemQuantValArr } from "./model.js";
import { item1QuantEl, item2QuantEl, item3QuantEl, itemQuantElArr } from "./view.js";
import { itemDiscPriceValArr, itemFullPriceValArr } from "./model.js";

import { item1RemainsVal, item2RemainsVal, item3RemainsVal, itemRemainsValArr } from "./model.js";
...
import { item1DiscPriceEl, item2DiscPriceEl, item3DiscPriceEl } from "./view.js";
import { item1DiscCurEl, item2DiscCurEl, item3DiscCurEl } from "./view.js";
import { item1FullPriceEl, item2FullPriceEl, item3FullPriceEl } from "./view.js";
import { item1FullCurEl, item2FullCurEl, item3FullCurEl } from "./view.js";

import { item1DiscPriceVal, item2DiscPriceVal, item3DiscPriceVal } from "./model.js";
import { item1DiscCurVal, item2DiscCurVal, item3DiscCurVal } from "./model.js";
import { item1FullPriceVal, item2FullPriceVal, item3FullPriceVal } from "./model.js";
import { item1FullCurVal, item2FullCurVal, item3FullCurVal } from "./model.js";

import { renderDeliveryCost, deliverySection, renderMissItemsNum, renderDelivery } from "./view.js";
...
import { selectedResultQuantVal, selectedResultDiscountVal, selectedResultFullPriceVal, selectedResultCostVal } from "./model.js";
import { selectedResultDiscPriceValArr, selectedResultFullPriceValArr, selectedResultQuantValArr } from "./model.js";
...
import { selectCheckboxEl, selectAllCheckboxEl, selectAllCheckboxHandler } from "./view.js";

import { priceRerender, priceFormatting, renderRemainsComment } from "./view.js";
import { manageQuantBtnStyle, quantBtns } from "./view.js";

import { collapseBlockHandler, collapseBtnEl, calcCollapsHeight } from "./view.js";
import { cartItemsWrap, cartWrap, missItemsWrap, cartItems } from "./view.js";

import { toggleModal, recalcCollapsHeight } from "./view.js";
import { changeDeliveryBtnEl, changeDeliveryCloseBtnEl, changeDeliveryModalEl, resultDeliveryInterval } from "./view.js";
import { changePaymentBtnEl, changePaymentCloseBtnEl, changePaymentModalEl } from "./view.js";

import { changeDeliveryTabHandler, changeDeliveryTabsEl } from "./view.js";
import { renderSelectedPaymentHandler, renderSelectedDeliveryHandler, paymentOptionSelectBtnEl } from "./view.js";
import { deleteDeliveryOptionHandler, checkInstantPayHandler } from "./view.js";
import { renderFavouritesBadge, scrollToDeliverySection, refreshOrderBtnPrice } from "./view.js";
import { addingItemToFavourites } from "./model.js";

import { refuseDescrTooltipHandler, sellerTooltipHandler, discountTooltipHandler } from "./view.js";
import { calcDiscountTooltip, itemDiscVal, userDiscVal } from "./model.js";

import { provideInputValidationView, receiverFormEl, scroollToInvalidInput } from "./view.js";
...
collectSelected();
calcSelected();
renderSelectedResults(selectedResultQuantVal, selectedResultFullPriceVal, selectedResultDiscountVal, selectedResultCostVal, currentCurrencyVal);
...
cartItemsWrap.addEventListener("click", function (e) {
  ...
  if (e.target.classList.contains("cart-item__minus-btn") || e.target.classList.contains("cart-item__plus-btn")) {
...
cartWrap.addEventListener("click", function (e) {
  ...
  discountTooltipHandler(itemObj, userDataObj, userDiscVal, itemDiscVal, tooltip);
})
...
const initValidation = function () {
  ...
  document.querySelectorAll(".js-validate").forEach((inputEl) => {
    inputEl.addEventListener("blur", (e) => { inputValidation(e.target) });
