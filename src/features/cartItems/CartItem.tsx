      ...
      >
        ...
        <div className="cart-item__properties caption">
          <p className="cart-item__properties-color">
            {itemData.properties[0]?.name && itemData.properties[0]?.name}
            <span>
              {itemData.properties[0]?.value &&
                ": " + itemData.properties[0]?.value.toString()}
            </span>
          </p>
          <p className="cart-item__properties-size">
            {itemData.properties[1]?.name && itemData.properties[1]?.name}
            <span>
              {itemData.properties[1]?.value &&
                ": " + itemData.properties[1]?.value.toString()}
            </span>
          </p>
        </div>
